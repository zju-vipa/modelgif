...
def load_model(num, mode):
    if mode == 'teacher':
        ...
        model.load_state_dict(
            torch.load(os.path.join("model", "vgg_model.pth")))
        ...
        model.load_state_dict(
            torch.load(
                os.path.join("model", "student_model_1_" + str(num) + ".pth")))
        ...
        model.load_state_dict(
            torch.load(
                os.path.join("model", "clean_model_" + str(num) + ".pth")))
        ...
        model.load_state_dict(
            torch.load(
                os.path.join("finetune_model",
                             "finetune_C_" + str(num) + ".pth")))
        ...
        model.load_state_dict(
            torch.load(
                os.path.join("finetune_model",
                             "finetune_cifar10c_" + str(num) + ".pth")))
        ...
        model.load_state_dict(
            torch.load(os.path.join("adv_train", "adv_" + str(num) + ".pth")))
        ...
        model.load_state_dict(
            torch.load(
                os.path.join("finetune_10", "finetune" + str(num) + ".pth")))
